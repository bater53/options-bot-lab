"""
LAB: Double-bottom pattern on SPY 5m candles.

Run with:
    python -m src.backtest.run_double_bottom_spy_lab
"""
...
def load_spy_5m(period: str = "60d") -> pd.DataFrame:
    """
    Load SPY 5m candles from yfinance for the given period.
    ...
    # If columns are MultiIndex, slice down to the SPY sub-frame
...
def summarize_trades(trades: List[PlannedTrade]) -> None:
    ...
    print()
    print("=== Double Bottom Backtest on SPY (5m) ===")
